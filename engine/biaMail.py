...
g_log = logging.getLogger("master")
...
def send_smtp_message(msg: SmtpMessage, host: str, port: int, debug: int = 0) -> None:
    """
...
def get_message_location(msg: Message) -> tuple:
    ...
    A tuple of (str, str, str):
        ...
        third param: name of the mesage's parent folder
    """
...
def download_attachments(msg: object, folder_path: str, ext: str = None) -> list:
    """
...
def get_messages2(
    ...
    emails = emails.only('attachments', 'message_id')
...
def get_message_id_strings(acc: Account, *folders: str) -> tuple:
    """
...
def find_hash_value(msg: Message, key_patt: str) -> Union[str,None]:
    """
    Finds a hash key in the message
    ...
    If the key is not found in the message body text, then None is returned.
    """
